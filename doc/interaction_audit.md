...
| Pivot, command bar, and FlipView | Header selection semantics, keyboard navigation, command toggle semantics, controlled and uncontrolled paging, dragging, circular keyed children, RTL, banners, adjustable semantics, reduced motion, and theme precedence in `test/navigation`. |
