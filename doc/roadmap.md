...
## Core Modern UI controls — complete for 0.1.0
...
- declared Flutter 3.32 lower bound — current stable and Flutter 3.32 pass
  analysis and all 228 non-Golden tests in hosted CI
...
- Windows, Web, macOS, Linux, Android, and iOS package validation — complete in
  hosted CI, with iOS built unsigned
